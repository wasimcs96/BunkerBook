					...
					<div class="col-xl-8">
						<div class="single-blog">
							...
							<div class="single-content">
								...
								<div class="single-page-img">
									<img src="{{asset('frontEnd/assets/img/singlepost/single2.jpg')}}" alt="thumb">
								</div>
								<a href="single.html"><h2 class="single-content-title">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio, aspernatur.</h2></a>
								<div class="single-content-text">
									<p class="mb-0">
										Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolor magna ali Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodot consequa. Duis aute irures dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatuo Excepteur sint occcat cupidatat nonm proident, sunt in culpa qui officia deserunt 
									</p>
							...
							<div class="single-content">
								...
								<div class="single-page-img">
									<img src="{{asset('frontEnd/assets/img/singlepost/single3.jpg')}}" alt="thumb">
								</div>
								<a href="single.html"><h2 class="single-content-title">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, aspernatur.</h2></a>
								<div class="single-content-text">
									<p class="mb-0">
										Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolor magna ali Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodot consequa. Duis aute irures dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatuo Excepteur sint occcat cupidatat nonm proident, sunt in culpa qui officia deserunt 
									</p>
