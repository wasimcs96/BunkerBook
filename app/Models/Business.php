...
class Business extends Model
{
    ...
    protected $fillable = [
                            'plan_type', 'name', 'email', 'category','category_name', 'website', 'landline', 'address', 'country', 'start_time','state','city','mobile','user_id','business_time','status','reject_reason','personal_info',
